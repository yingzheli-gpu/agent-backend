"""
智谱 GLM LangChain 包装器

由于 LangChain 的 ChatOpenAI 不支持 extra_body 参数传递，
我们创建一个自定义包装器来支持智谱 GLM 的 thinking mode
"""
...
class Chat(BaseChatOpenAI):
    """
    智谱 GLM 的 LangChain 包装器
    
    使用原生 OpenAI SDK，但提供 LangChain 兼容的接口
    """
